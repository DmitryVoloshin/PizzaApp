        ...
        <div id="myCarousel" className="carousel slide">
              ...
              <div className="carousel-inner">
                  <div className="item active">
                      ...
                      <div className="fill" style="background-image:url('http://www.marchettidesign.net/demo/optimized-bootstrap/code.jpg');"></div>
                  ...
                  <div className="item">
                      ...
                      <div className="fill" style="background-image:url('http://www.marchettidesign.net/demo/optimized-bootstrap/conference.jpg');"></div>
                      <div className="carousel-caption">
                  ...
                  <div className="item">
                      ...
                      <div className="fill" style="background-image:url('http://www.marchettidesign.net/demo/optimized-bootstrap/campus.jpg');"></div>
                      <div className="carousel-caption">
